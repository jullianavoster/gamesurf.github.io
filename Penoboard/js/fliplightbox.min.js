...
var flb_settings = $.extend({
        ...
        lightbox_text_background_style: 'background-color: #01983b; opacity:0.8;',
        ...
        next_and_back_image_text_style: 'color: #ffffff;',
    
        image_number_page: 'Сертификат',
    
        image_number_of: 'из',
    
        image_number_text_style: 'font-weight: bold; color: #000000;',
